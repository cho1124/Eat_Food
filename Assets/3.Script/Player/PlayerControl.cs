...
public class PlayerControl : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        is_dead = false;
        transform.position = GameObject.Find("Map_Generator").GetComponent<Map_Generator>().Get_Spawn_Position();
    }
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            Debug.Log("음식 처리");
            GameObject.Find("ObstacleSpawner").GetComponent<ObstacleSpawner>().List_Active_False_ToPlayer(other.gameObject);
        }
    }
}
